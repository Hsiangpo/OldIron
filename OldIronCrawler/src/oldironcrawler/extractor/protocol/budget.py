...
REQUEST_SLOT_WAIT_FLOOR_SECONDS = 20.0
REQUEST_SLOT_WAIT_CAP_SECONDS = 45.0
REQUEST_SLOT_WAIT_MULTIPLIER = 4.0
DISCOVERY_HOMEPAGE_TIMEOUT_CAP_SECONDS = 20.0
PAGE_FETCH_REQUEST_TIMEOUT_CAP_SECONDS = 8.0
