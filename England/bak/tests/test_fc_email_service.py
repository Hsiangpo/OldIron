...
class FirecrawlEmailServiceTests(unittest.TestCase):
    ...
    def test_discover_emails_stops_after_first_zero_result(self) -> None:
        ...
        self.assertEqual(43200, result.retry_after_seconds)
        self.assertEqual(1, len(service._firecrawl.map_calls))
