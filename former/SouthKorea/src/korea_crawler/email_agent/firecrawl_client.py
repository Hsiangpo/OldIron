"""Firecrawl 同步客户端（复用 Malaysia 方案）。"""
...
from .key_pool import FirecrawlKeyPool, KeyLease
...
class FirecrawlClient:
    ...
    def _request_once(self, lease: KeyLease, method: str, path: str, *, json_body: dict | None = None) -> dict:
