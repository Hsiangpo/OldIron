...
class DnbKoreaBrowserCookieTests(unittest.TestCase):
    def test_build_cookie_header_filters_non_dnb_domains(self) -> None:
        from korea_crawler.dnb.browser_cookie import _build_cookie_header
    ...
    def test_resolve_dnb_cookie_header_updates_env_file(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("korea_crawler.dnb.browser_cookie.fetch_live_dnb_cookie_header", return_value="new=value; bm_sv=1"):
    ...
    def test_cookie_provider_refreshes_on_force(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            with patch("korea_crawler.dnb.browser_cookie.resolve_dnb_cookie_header", side_effect=lambda **_: next(values)):
