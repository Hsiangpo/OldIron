...
from unitedstates_crawler.sites.dnb.catalog import LEGACY_SUBCATEGORY_SLUGS
from unitedstates_crawler.sites.dnb.catalog import TOP_LEVEL_CATEGORY_SLUGS
from unitedstates_crawler.sites.dnb.catalog import build_initial_segments
...
class DnbCatalogTests(unittest.TestCase):
    ...
    def test_initial_segments_are_seeded_from_subcategories(self) -> None:
        ...
        self.assertEqual("us", segments[0]["country_iso_two_code"])
    ...
    def test_initial_segments_can_be_limited_to_specific_industries(self) -> None:
        ...
        self.assertEqual("beverage_manufacturing|us||", segments[0]["segment_id"])
        self.assertEqual("construction|us||", segments[1]["segment_id"])
