...
from .store import UnitedStatesWizaStore


LOGGER = logging.getLogger("unitedstates.wiza.pipeline")
...
def run_pipeline_list(
    *,
    ...
    """抓取 Wiza UnitedStates 公司列表，仅保留网站。"""
    del concurrency
...
def _export_websites(output_dir: Path, store: UnitedStatesWizaStore) -> None:
