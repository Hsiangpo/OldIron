...
LOGGER = logging.getLogger("germany.common.cli")
POLL_INTERVAL = 20
MAX_IDLE_ROUNDS = 3
P1_RETRY_LIMIT = 6
...
def run_site_cli(
    *,
    ...
    if args.mode == "all":
        return _run_all_concurrent(site_name, output_dir, proxy, args, run_list, enable_gmap=enable_gmap)
...
def _run_all_concurrent(
    ...
    *,
    ...
    for thread in threads:
        thread.join()
    total = GermanyCompanyStore(output_dir / "companies.db").get_company_count()
